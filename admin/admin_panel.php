...
<body>
    ...
    <a class="button" href="http://localhost/edusogno/edusogno-esercizio/pages/profile/profile.php"> Profile</a>
    <h1>Utenti</h1>
    <table border="1">
        <tr>
            <th>ID</th>
        ...
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td><a href="http://localhost/edusogno/edusogno-esercizio/admin/edit_user.php?id=<?= $user['id'] ?>">Modifica</a></td>
            </tr>
        <?php endforeach; ?>
    </table>
    ...
    <table border="1">
        ...
        <?php foreach ($events as $event): ?>
            <tr>
                ...
                <td><a href="http://localhost/edusogno/edusogno-esercizio/admin/edit_event.php?id=<?= $event['id'] ?>">Modifica</a></td>
            </tr>
        <?php endforeach; ?>
    </table>
</body>
