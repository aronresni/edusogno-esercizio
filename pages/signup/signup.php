...
<body>
    ...
    <div class="container">
        ...
        <form action="http://localhost/edusogno/edusogno-esercizio/pages/signup/signup.php" method="post" onsubmit="return validateForm()">
            ...
            <a href="http://localhost/edusogno/edusogno-esercizio/pages/login/login.php">Hai già un account? Accedi</a>
        </form>
    </div>
